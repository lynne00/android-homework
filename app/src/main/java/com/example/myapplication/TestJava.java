...
public class TestJava extends AppCompatActivity {
    ...
    CheckBox zq6;
    CheckBox zq7;
    public DBexam dBexam;
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.testjava);
        ...
        public void onClick(View v)
        {
            switch (v.getId()) {
                case R.id.submit:
                    ...
                    if (zq5.isChecked() && zq6.isChecked() && zq7.isChecked()) {
                        sumScore += 20;
                    }
                    Toast toast = Toast.makeText(TestJava.this, "您得了" + sumScore + "分", Toast.LENGTH_SHORT);
                    toast.show();
                    DBexam.getInstance(TestJava.this).updateUserExam("javaexam",
